...
var projectName = "Polly.Web.EventStream";
var keyName = "Polly.Web.EventStream.snk";
    ...
    .Does(() =>
{
    foreach(var project in projectToNugetFolderMap.Keys) {
        ...
        foreach(var targetFolder in projectToNugetFolderMap[project]) {
			var srcDirCopy = project == "Core" ? sourceDir + Directory(targetFolder) : sourceDir;
...
Task("__CreateNugetPackage")
    .Does(() =>
{
    var nugetVersion = gitVersionOutput["MajorMinorPatch"].ToString(); //TODO:gitVersionOutput["NuGetVersion"].ToString();
